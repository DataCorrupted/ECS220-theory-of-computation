\section*{Crossover logic}
    ...
    Then general idea is $a \texttt{ xor } b = !((!a \wedge !b) \vee (a \wedge b))$.
    
    The circuit for $a \texttt{ xor } b$ is shown in the next figure. We assumed input for $a$ and $b$ and listed all true value in the edges.
